...
--
-- Host: localhost:3306
-- Generation Time: May 25, 2023 at 06:04 PM
...
--
-- Database: `anastasia_dorfman_portfolio`
--
...
INSERT INTO `blogs` (`blog_id`, `name`, `url`) VALUES
(1, 'MY main blog', 'http://localhost/blog.php');
...
INSERT INTO `images` (`image_id`, `type`, `name`, `link`, `post_id`, `project_id`) VALUES
(3, 'image', 'post1_image2', './assets/images/post1_image2.png', 1, NULL),
(9, 'avatar', 'post16_avatar', './assets/images/post16_avatar.jpeg', 16, NULL),
(10, 'image', 'post16_image1', './assets/images/post16_image1.jpg', 16, NULL),
(27, 'avatar', 'project1_avatar', './assets/images/project1_avatar.png', 1, NULL),
(28, 'image', 'project1_image3', './assets/images/project1_image3.png', 1, NULL),
(36, 'avatar', 'project17_avatar', './assets/images/project17_avatar.jpg', 17, NULL),
(37, 'image', 'project17_image1', './assets/images/project17_image1.jpg', 17, NULL),
(38, 'avatar', 'project18_avatar', './assets/images/project18_avatar.png', 18, NULL),
(39, 'avatar', 'project7_avatar', './assets/images/project7_avatar.png', NULL, 7),
(40, 'image', 'project7_image1', './assets/images/project7_image1.png', NULL, 7),
(41, 'image', 'project7_image2', './assets/images/project7_image2.png', NULL, 7),
(43, 'image', 'project8_image1', './assets/images/project8_image1.png', NULL, 8),
(44, 'image', 'project8_image2', './assets/images/project8_image2.png', NULL, 8),
(45, 'image', 'project8_image3', './assets/images/project8_image3.png', NULL, 8),
(47, 'image', 'project9_image1', './assets/images/project9_image1.png', NULL, 9),
(48, 'image', 'project9_image2', './assets/images/project9_image2.png', NULL, 9),
(49, 'image', 'project9_image3', './assets/images/project9_image3.png', NULL, 9),
(51, 'image', 'project10_image1', './assets/images/project10_image1.png', NULL, 10),
(52, 'image', 'project10_image2', './assets/images/project10_image2.png', NULL, 10),
(53, 'image', 'project10_image3', './assets/images/project10_image3.png', NULL, 10),
(55, 'avatar', 'project10_avatar', './assets/images/project10_avatar.png', NULL, 10),
(59, 'avatar', 'project8_avatar', './assets/images/project8_avatar.png', NULL, 8),
(60, 'avatar', 'project9_avatar', './assets/images/project9_avatar.png', NULL, 9),
(61, 'avatar', 'project11_avatar', './assets/images/project11_avatar.png', NULL, 11),
(62, 'image', 'project11_image1', './assets/images/project11_image1.png', NULL, 11),
(63, 'image', 'project11_image2', './assets/images/project11_image2.png', NULL, 11);
...
INSERT INTO `projects` (`id`, `name`, `overview`, `created_at`, `code_link`, `description`) VALUES
...
INSERT INTO `tags` (`name`, `is_tool`) VALUES
('AI', b'0'),
('ASP.Net', b'1'),
('Boot Spring', b'1'),
('Bootstrap', b'1'),
...
INSERT INTO `users` (`user_id`, `f_name`, `l_name`, `email`, `password`, `u_name`, `avatar`, `created_at`, `user_type`) VALUES
(3, 'Anastasia', 'Dorfman', 'anastasia.dorfman1@gmail.com', '$2y$10$FEqajPyD0VsK5W/U.xBjneugnp/MbcOlYjTBjGnBMe9hTekm0.9F2', '@AD', NULL, '2023-04-19 19:13:11', 'admin'),
(4, 'Delon', 'Van de Venter', 'delon.vandeventer@nbcc.ca', '$2y$10$wkC99kKjSr/mJ3ILH1vlxe2oMtSrZfa3hN0B22.8piuwtXA19Pug.', '@Delon', NULL, '2023-04-20 19:13:11', 'user');
...
INSERT INTO `works` (`work_id`, `name`, `description`) VALUES
(1, 'Restraunt', NULL),
(2, 'Hotel Reservation System', NULL),
(3, 'Card Game', NULL),
(4, 'Mobile App', NULL),
(5, 'Realtor Agency', NULL),
(6, 'Social Media', NULL);
...
ALTER TABLE `images`
  ...
  ADD KEY `FK_images_posts_idx` (`post_id`),
  ADD KEY `FK_images_projects_idx` (`project_id`);
...
ALTER TABLE `post_tags`
  ...
  ADD KEY `FK_post_tags_tag_name_idx` (`tag_name`);
...
ALTER TABLE `project_skills`
  ...
  ADD KEY `FK_project_skills_skill_name_idx` (`skill_name`);
...
--
ALTER TABLE `images`
  ADD CONSTRAINT `FK_images_posts` FOREIGN KEY (`post_id`) REFERENCES `posts` (`post_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_images_projects` FOREIGN KEY (`project_id`) REFERENCES `projects` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `posts`
--
ALTER TABLE `posts`
  ADD CONSTRAINT `FK_posts` FOREIGN KEY (`blog_id`) REFERENCES `blogs` (`blog_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
ALTER TABLE `post_tags`
  ADD CONSTRAINT `FK_post_tags_post_id` FOREIGN KEY (`post_id`) REFERENCES `posts` (`post_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_post_tags_tag_name` FOREIGN KEY (`tag_name`) REFERENCES `tags` (`name`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `project_skills`
--
ALTER TABLE `project_skills`
  ADD CONSTRAINT `FK_project_skills_project_id` FOREIGN KEY (`project_id`) REFERENCES `projects` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_project_skills_skill_name` FOREIGN KEY (`skill_name`) REFERENCES `skills` (`name`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
