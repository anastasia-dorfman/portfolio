  ...
  <div class="main-container">
    <div class="main-footer__upper">
      ...
      <div class="main-footer__row main-footer__row-2">
        <h4 class="heading heading-sm text-lt">Anastasia Dorfman</h4>
        <p class="main-footer__short-desc">
          Passionate about creating efficient and user-friendly web solutions using the latest technologies
        </p>
      </div>
    </div>
